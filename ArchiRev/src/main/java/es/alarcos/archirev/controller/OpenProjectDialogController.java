...
public class OpenProjectDialogController extends AbstractDialogController {
	...
	private static Logger logger = LoggerFactory.getLogger(OpenProjectDialogController.class);
    ...
    public boolean isOpenProject(final Project project) {
    	return sessionController.getProject()!=null && project.getId().equals(sessionController.getProject().getId());
    }
